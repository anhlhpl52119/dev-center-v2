...
export type PageMutation = {
  ...
  removeHistory?: Maybe<DefaultResponse>;
...
export type PagesHomeQueryVariables = Exact<{
  tags: Array<Scalars['String']['input']> | Scalars['String']['input'];
}>;


export type PagesHomeQuery = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', menu: Array<{ __typename?: 'PageMenuItem', id: number, path: string, locale: string, title?: string | null, category?: string | null }> } | null };

export type Pages2QueryVariables = Exact<{
  path?: InputMaybe<Scalars['String']['input']>;
  mode: PageTreeMode;
  locale: Scalars['String']['input'];
}>;
...
export type Pages2Query = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', tree?: Array<{ __typename?: 'PageTreeItem', id: number, path: string, depth: number, title: string, isPrivate: boolean, isFolder: boolean, privateNS?: string | null, parent?: number | null, pageId?: number | null, locale: string } | null> | null } | null };

export type Pages3QueryVariables = Exact<{
  query: Scalars['String']['input'];
  category?: InputMaybe<Scalars['String']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
...
export type Pages3Query = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', search: { __typename?: 'PageSearchResponse', totalHits: number, results: any, description: any } } | null };

export type Pages4QueryVariables = Exact<{
  tags: Array<Scalars['String']['input']> | Scalars['String']['input'];
}>;


export type Pages4Query = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', menu: Array<{ __typename?: 'PageMenuItem', id: number, title?: string | null, category?: string | null }> } | null };

export type Pages5QueryVariables = Exact<{
  id: Scalars['Int']['input'];
  getLatest?: InputMaybe<Scalars['Boolean']['input']>;
}>;


export type Pages5Query = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', history?: { __typename?: 'PageHistoryResult', trail?: Array<{ __typename?: 'PageHistory', versionId: number, versionDate: any, authorId: number, authorName: string, actionType: string, valueBefore?: string | null, valueAfter?: string | null, version?: string | null } | null> | null } | null } | null };

export type Pages6QueryVariables = Exact<{
  pageId: Scalars['Int']['input'];
  versionId: Scalars['Int']['input'];
}>;


export type Pages6Query = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', version?: { __typename?: 'PageVersion', action: string, content: string, contentType: string, createdAt: any, versionDate: any, description: string, locale: string, pageId: number, path: string, publishEndDate: any, publishStartDate: any, title: string, versionId: number, version?: string | null } | null } | null };

export type Pages7QueryVariables = Exact<{
  path: Scalars['String']['input'];
  locale: Scalars['String']['input'];
}>;


export type Pages7Query = { __typename?: 'Query', pages?: { __typename?: 'PageQuery', singleByPath?: { __typename?: 'Page', id: number, title: string, content: string, updatedAt: any } | null } | null };


export const PagesHomeDocument = gql`
    query PagesHome($tags: [String!]!) {
  pages {
    menu(tags: $tags) {
      id
      path
    ...
    `;
export const Pages2Document = gql`
    query Pages2($path: String, $mode: PageTreeMode!, $locale: String!) {
  pages {
    tree(path: $path, mode: $mode, locale: $locale) {
      id
      path
      depth
      title
    ...
    `;
export const Pages3Document = gql`
    query Pages3($query: String!, $category: String, $locale: String, $page: Int, $size: Int, $inCategory: [String]) {
  pages {
    search(
      query: $query
      category: $category
    ...
    `;
export const Pages4Document = gql`
    query Pages4($tags: [String!]!) {
  pages {
    menu(tags: $tags) {
      id
      title
    ...
    `;
export const Pages5Document = gql`
    query Pages5($id: Int!, $getLatest: Boolean) {
  pages {
    ...
    `;
export const Pages6Document = gql`
    query Pages6($pageId: Int!, $versionId: Int!) {
  pages {
    ...
    `;
export const Pages7Document = gql`
    query Pages7($path: String!, $locale: String!) {
  pages {
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    PagesHome(variables: PagesHomeQueryVariables, options?: C): Promise<ExecutionResult<PagesHomeQuery, E>> {
      return requester<PagesHomeQuery, PagesHomeQueryVariables>(PagesHomeDocument, variables, options) as Promise<ExecutionResult<PagesHomeQuery, E>>;
    },
    Pages2(variables: Pages2QueryVariables, options?: C): Promise<ExecutionResult<Pages2Query, E>> {
      return requester<Pages2Query, Pages2QueryVariables>(Pages2Document, variables, options) as Promise<ExecutionResult<Pages2Query, E>>;
    },
    Pages3(variables: Pages3QueryVariables, options?: C): Promise<ExecutionResult<Pages3Query, E>> {
      return requester<Pages3Query, Pages3QueryVariables>(Pages3Document, variables, options) as Promise<ExecutionResult<Pages3Query, E>>;
    },
    Pages4(variables: Pages4QueryVariables, options?: C): Promise<ExecutionResult<Pages4Query, E>> {
      return requester<Pages4Query, Pages4QueryVariables>(Pages4Document, variables, options) as Promise<ExecutionResult<Pages4Query, E>>;
    },
    Pages5(variables: Pages5QueryVariables, options?: C): Promise<ExecutionResult<Pages5Query, E>> {
      return requester<Pages5Query, Pages5QueryVariables>(Pages5Document, variables, options) as Promise<ExecutionResult<Pages5Query, E>>;
    },
    Pages6(variables: Pages6QueryVariables, options?: C): Promise<ExecutionResult<Pages6Query, E>> {
      return requester<Pages6Query, Pages6QueryVariables>(Pages6Document, variables, options) as Promise<ExecutionResult<Pages6Query, E>>;
    },
    Pages7(variables: Pages7QueryVariables, options?: C): Promise<ExecutionResult<Pages7Query, E>> {
      return requester<Pages7Query, Pages7QueryVariables>(Pages7Document, variables, options) as Promise<ExecutionResult<Pages7Query, E>>;
    }
  };
}
